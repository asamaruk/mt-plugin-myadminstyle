...
%Lexicon = (
  'My Admin Style Description' => 'Customize by loading your own files into the admin panel. Beta version.',
  ...
  'My Upload Path Description' => 'Specify the folder for the upload.',
);
